...
export class ProductDetailComponent implements OnInit {
  ...
  scrollToReviewForm(): void {
    ...
    if (element) {
      ...
      console.error('No se pudo encontrar el elemento del formulario de reseña.');
    }
  }
  ...
  submitReview(): void {
    ...
    if (this.reviewForm.valid && currentProduct) {
      ...
      this.productService.addReview(currentProduct._id, newReview).subscribe(savedReview => {
  ...
  addToCart(): void {
    ...
    if (currentProduct) {
      ...
      // Podríamos usar un "toast" o "snackbar" aquí para una mejor UX
